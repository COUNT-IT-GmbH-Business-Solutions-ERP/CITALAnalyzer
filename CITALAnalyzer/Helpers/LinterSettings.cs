...
namespace CITALAnalyzer.Helpers
{
    ...
    {
        private const string settingsFileName = "CITALAnalyzer.json";
        ...
        static public void Create(string WorkingDir)
        {
            if (instance is null || instance.WorkingDir != WorkingDir)
            {
                ...
                // If the settings file is not found in the working directory, look in the location of the CITALAnalyzer file itself
